...
// node_modules/.pnpm/vue3-toastify@0.2.4_vue@3.5.13_typescript@5.7.2_/node_modules/vue3-toastify/dist/index.mjs
...
function nt({
  ...
  return n ? o = oe.spinner() : a === false ? o = void 0 : G(a) ? o = T(a) : B(a) ? o = a(s) : de(a) ? o = pe(a, s) : ae(a) || ze(a) ? o = a : tt(t) && (o = oe[t](s)), o;
}
var at = () => {
};
...
function st(e) {
  const t = q(false), n = q(false), a = q(false), o = q(V.Enter), s = F({
    ...e,
